...
public interface IRenderer {
    ...
    void fillCircle(float x, float y, float radius, int segments, float r, float g, float b, float a);
    ...
    void drawImage(MyImage image,int dx,int dy,int sx,int sy,int w,int h);

    ...
    private boolean writeKeyframe(Scene scene) {
        ...
        for (GameObject obj : objs) {
            ...
            sb.append('{')
                    ...
                    .append("\"order\":").append(qfmt.format(((Moveable)obj).getID())).append(',')
            ...
            if (rc != null) {
                ...
                if(obj.getName().equals("Bullet")){
                    ...
                    com.gameengine.components.RenderComponent.Color col = bullet.getColor();
                    sb.append(",")
                            .append("\"w\":").append(qfmt.format(2*bullet.getCur_radius())).append(',')
                            .append("\"color\":[")
                            .append(qfmt.format(col.r)).append(',')
                            .append(qfmt.format(col.g)).append(',')
                            .append(qfmt.format(col.b)).append(',')
                    ...
                    sb.append("\"HP\":").append(qfmt.format(move.getHP()));
                }

...
//                throw new UnsupportedOperationException();
    ...
    public void render() {
        ...
        renderer.fillRect(0, 0, width, height, 0.25f, 0.25f, 0.35f, 1.0f);
    ...
    private void renderMainMenu() {
        ...
        renderer.fillRect(centerX - titleWidth / 2.0f - 20, titleY - 40, titleWidth + 40, 80, 0.4f, 0.4f, 0.5f, 1.0f);
        ...
        for (int i = 0; i < options.length; i++) {
            ...
            if (i == selectedIndex) {
                ...
                g = 1.0f;
                b = 0.5f;
                renderer.fillRect(textX - 20, textY - 20, textWidth + 40, 50, 0.6f, 0.5f, 0.2f, 0.9f);
            } else {
                r = 0.95f;
                g = 0.95f;
                b = 0.95f;
                renderer.fillRect(textX - 20, textY - 20, textWidth + 40, 50, 0.2f, 0.2f, 0.3f, 0.5f);
            }
